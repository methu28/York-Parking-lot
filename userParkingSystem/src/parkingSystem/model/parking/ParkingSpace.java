...
public class ParkingSpace {
    ...
    public boolean isAvailable(LocalDateTime start, LocalDateTime end) {
        ...
        for(Booking booking : bookings) {
            if(end.isAfter(booking.getStartTime()) && start.isBefore(booking.getStartTime())) {
                return false;
            }
            else if(start.isBefore(booking.getEndTime()) && end.isAfter(booking.getEndTime())) {
                return false;
            }
        }
        return true;
    ...
    public LocalDateTime getNextAvailableTime(LocalDateTime start) {
        ...
        for(Booking booking : bookings) {
            if(reqStart.isAfter(booking.getStartTime()) && reqStart.isBefore(booking.getEndTime())) {
                reqStart = booking.getEndTime();
                break;
            }
        }
        return reqStart;
